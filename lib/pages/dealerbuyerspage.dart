...
class DealerPage2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return DealerContent2();
  }
}

class DealerContent2 extends StatefulWidget {
  const DealerContent2({super.key});
  @override
  State<DealerContent2> createState() => _DealerPageState();
}

class _DealerPageState extends State<DealerContent2> {
