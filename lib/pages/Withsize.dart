    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: CustomTabBar(
            ...
            tabViewItems: [
              Container(child: Requests()),
              Card(child: Container(child: ConfirmedOrders())),
              Card(child: Container(child: CompletedOrder()))
            ]),
      ),
    );
  }
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                    ...
                    child:
                    requestList[index].orderType == "With Size"
                        ? RequestCard(index)
                        : Container());
                // }
                // return null;
...
Widget CompletedOrderCard(BuildContext context, Order order, String? curr_user_id) {
  if (order.status == 'Denied'|| order.status=='Completed') {
    return Card(
...
Widget ConfirmorderCard(BuildContext context, Order order, String? curr_user_id) {
  if (order.status == 'Confirmed') {
    return Card(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
      color: Colors.white,
